/*
KNXnet/IP DEVICE_CONFIGURATION_ACK frame body
...
const {
    KNXNETIP_SERVICE_TYPES : { DEVICE_CONFIGURATION_ACK }
} = require('../../constants');

class FrameBody__DEVICE_CONFIGURATION_ACK extends BaseKNXStructure {
    constructor(data) {
        super(data);
        this.service_type = DEVICE_CONFIGURATION_ACK;
    }
...
module.exports = FrameBody__DEVICE_CONFIGURATION_ACK;
